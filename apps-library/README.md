...
|---|---|---|
| [2048](2048) | 1.4.1 | The whole surface at its smallest: the SDK bridge, private saved games, keyboard and touch input, detachable views, and an agent that can take one turn or play on its own |
| [Checkers](checkers) | 1.3.1 | Turn ownership enforced by the engine, so an agent playing out of turn is refused rather than trusted |
