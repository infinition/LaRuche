...
| [DS Studio](ds-studio) | 1.7.8 | A Python notebook an agent drives through twenty-seven declared actions, with datasets, charts, kept results and a notebook library |
