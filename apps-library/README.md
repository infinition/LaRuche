...
The layout of the two games is measured in a real browser, at several panel sizes
and several zoom levels. It needs Chrome or Edge and nothing else, and says so and
passes if it finds neither:
