...
| [Checkers](checkers) | 1.2.0 | Turn ownership enforced by the engine, so an agent playing out of turn is refused rather than trusted |
| [WASM Lab](wasm-demo) | 1.0.0 | A browser WebAssembly module running inside the sandbox |
| [DS Studio](ds-studio) | 1.7.3 | A Python notebook an agent drives through twenty-seven declared actions, with datasets, charts, kept results and a notebook library |
