...
2. **Élevée - Divergence entre `LaRuche` et ton repo local `miel-protocol`**
- `LaRuche` dépend de `miel-protocol` Git distant: [LaRuche/Cargo.toml:18](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/LaRuche/Cargo.toml:18)
- Lock actuel sur commit `49e4891...`: [Cargo.lock:956](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/LaRuche/Cargo.lock:956)
- Ce commit cache a `NODE_STALE_TIMEOUT_SECS = 15`: [cargo-checkout/discovery.rs:16](/C:/Users/infinition/.cargo/git/checkouts/miel-protocol-69879b049e5fc925/49e4891/src/discovery.rs:16)
- Ton repo local a `30`: [local miel-protocol/discovery.rs:16](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/discovery.rs:16)
...
4. **Élevée - QoS partiellement non fonctionnel dans `miel-protocol`**
- Les compteurs `active_*` pilotent `should_degrade` / `accepting_qos`: [qos.rs:115](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/qos.rs:115), [qos.rs:165](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/qos.rs:165), [qos.rs:180](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/qos.rs:180)
- Mais ils ne sont jamais incrémentés à la prise en charge (`dequeue` pop seulement): [qos.rs:146](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/qos.rs:146)
- Ils sont seulement décrémentés via `complete`: [qos.rs:153](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/qos.rs:153)
...
7. **Moyenne - Fragilité IPv6 (Miel/clients)**
- `miel-protocol` peut prendre une adresse non normalisée depuis mDNS: [discovery.rs:192](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/discovery.rs:192), [discovery.rs:194](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/discovery.rs:194)
- URLs construites en `http://{host}:{port}` sans bracket IPv6: [laruche-node/main.rs:287](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/LaRuche/laruche-node/src/main.rs:287), [manifest.rs:360](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/manifest.rs:360)
...
9. **Moyenne - Cohérence état swarm dans `miel-protocol::swarm`**
- `add_peer` met `Syncing`: [swarm.rs:139](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/swarm.rs:139)
- `heartbeat` ne promeut que `Suspect -> Active`: [swarm.rs:162](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/swarm.rs:162)
- `active_peer_count`/`plan_sharding` ne prennent que Active/Busy: [swarm.rs:193](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/swarm.rs:193), [swarm.rs:226](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/swarm.rs:226)
...
- README dit “Gzipped JSON payload” en mDNS: [miel-protocol/README.md:32](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/README.md:32)
- Implémentation actuelle repose sur TXT props: [manifest.rs:230](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/manifest.rs:230), [manifest.rs:271](/C:/DEV/Workspace/active/coding/_AI%20RESEARCH/miel-protocol/src/manifest.rs:271)
...
- `cargo check` dans `miel-protocol`: OK
- `cargo test` dans `miel-protocol`: non exécutable ici (environnement/toolchain `dlltool.exe` manquant)
- `npm run compile` dans `laruche-vscode`: OK

**Remarque synthèse**
- Le socle compile, mais il y a des écarts importants entre intention (Miel/QoS/Auth/docs) et comportement effectif (health client, QoS runtime, config file, dépendance protocole).  
