LaRuche.i18n.add({
  ...
  'chat.voiceModeTitle':        {fr:'Appeler LaRuche (mode vocal)', en:'Call LaRuche (voice mode)'},
  'chat.callHeader':            {fr:'En appel avec LaRuche', en:'In call with LaRuche'},
  ...
  function handleEvent(data) {
    ...
    switch(data.type) {
      ...
      case 'tools_selected':
        ...
        tChip.style.cssText = 'display:inline-block; background:rgba(var(--amber-rgb),0.1); border:1px solid rgba(var(--amber-rgb),0.2); color:var(--amber); padding:2px 8px; border-radius:12px; font-size:10px; margin-top:4px; margin-bottom:4px; margin-right:6px; cursor:pointer; font-family:var(--mono); transition:all 0.2s;';
      ...
      case 'status':
        ...
        if (memMatch && window.localStorage.getItem('laruche_hide_transparency') !== 'true') {
           ...
           mChip.style.cssText = 'display:inline-block; background:rgba(var(--purple-rgb),0.1); border:1px solid rgba(var(--purple-rgb),0.2); color:var(--purple); padding:2px 8px; border-radius:12px; font-size:10px; margin-top:4px; margin-bottom:4px; margin-right:6px; font-family:var(--mono);';
