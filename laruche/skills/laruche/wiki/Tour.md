...
[LaRuche inspects the project, recalls a similar bug it has seen before, finds the typo (openHvieModal instead of openHiveModal) and edits the file.]
...
[Navigating Wikipedia, reading the article and scrolling, driven inside the Chrome session that was already open.]
...
[The decisions/projet_alpha node, holding the fact before anyone asks for it.]

[Asked why the alpha project slipped, LaRuche finds the cause in cognitive memory, roadworks in the datacenter, and answers from it.]
...
[A proposed fact, waiting for approval before it enters memory.]
[One node of the graph, built up across conversations.]
...
[LaRuche researches an acquisition, writes its synthesis, and LaReine reviews then approves the answer before it is sent.]
...
[Orchestrator, scientist, systems engineer, attacker, contradictor and arbiter, each with its role, deliberating on one question.]

## What it is doing, and what it is keeping

[The activity feed on the right, memory proposals on the left.]

## Reflexes, tasks and long goals

[A watcher on a file, with a Telegram alert.]
[The board, from To do to Done.]
[Scheduled research missions.]
...
[Live CPU, RAM, GPU and VRAM load, the models available across the mesh, and the hive's audit log.]
