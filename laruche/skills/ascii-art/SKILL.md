...
version: 4.0.0
author: 0xbyt4, third-party agent
license: MIT
dependencies: []
...
```bash
python3 -m pyfiglet "third-party" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=third-party&font=Slant" | boxes -d stone
```
